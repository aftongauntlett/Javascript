...
document.getElementById("Turn on the light").addEventListener("click", function () {

    document.getElementById('Turn on the light').src='https://www.w3schools.com/js/pic_bulbon.gif'


});

document.getElementById("Turn off the light").addEventListener("click", function () {

    document.getElementById('Turn off the light').src='https://www.w3schools.com/js/pic_bulboff.gif'
